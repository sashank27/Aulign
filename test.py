...
if __name__ == '__main__':
    ...
    #     plt.subplot(1, 3, field, aspect='equal').set_title(
    #         'Hy: %.2f (%s)' % (hy_ary[field - 1] * max_field, field_type))
    ...
    #             y_ary[field - 1, wave - 1, :]), '.', ms=1, color=colors[wave - 1])
    ...
    # print('RMS radius: %6.3f  %6.3f  %6.3f' % (spot_results.SpotData.GetRMSSpotSizeFor(
    #     1, 1), spot_results.SpotData.GetRMSSpotSizeFor(2, 1), spot_results.SpotData.GetRMSSpotSizeFor(3, 1)))
    # print('GEO radius: %6.3f  %6.3f  %6.3f' % (spot_results.SpotData.GetGeoSpotSizeFor(
    #     1, 1), spot_results.SpotData.GetGeoSpotSizeFor(2, 1), spot_results.SpotData.GetGeoSpotSizeFor(3, 1)))
    # #! [e22s07_py]
